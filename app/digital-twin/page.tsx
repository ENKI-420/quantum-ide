...
const TARGET_BELL_FIDELITY = 0.869
...
export default function DigitalTwinPage() {
  ...
  const [metrics, setMetrics] = useState<TwinMetric[]>([
    { label: "Bell Fidelity", value: 0.869, unit: "", target: 0.869, status: "NOMINAL" },
      ...
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold">.sh1ft Digital Twin</h1>
